...
{
    public class PurchaseOrdeMustHaveCustomer : Specification<PurchaseOrder>
    {
        public override string LocalizationSource { get; protected set; } = Constants.LocalizationSourceName;
        public override Enum LocalizationKey { get; protected set; } = PurchaseOrder.Error.PurchaseOrderMustHaveCustomer;

        public override Expression<Func<PurchaseOrder, bool>> ToExpression()
        {
            return (a) => a.CustomerId != Guid.Empty;
        }
    }
}
