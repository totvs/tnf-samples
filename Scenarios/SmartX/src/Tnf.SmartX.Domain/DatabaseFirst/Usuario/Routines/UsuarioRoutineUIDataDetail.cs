...
[SxRoutine(RoutineName = "GlbUsuarioRoutineDataDetail", Title = "UserRoutineDataDetail", Version = "1.0")]
public class UsuarioRoutineUIDataDetail : UsuarioModelEntity, ISXRoutineLayoutDataDetail
{
    public void ConfigureLayout(IRoutineLayoutDataDetailBuilder builder)
    {
        builder
