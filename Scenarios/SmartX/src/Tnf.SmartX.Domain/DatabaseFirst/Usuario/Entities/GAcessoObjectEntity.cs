...
public class GAcessoObjectEntity : SXObject<GAcessoObjectEntity>
{
    [SxProperty(ColumnName = "CODACESSO", Title = "Código do acesso", Description = "Código do acesso", Required = true,
        IsPrimaryKey = true, MaxLength = 16)]
    public string CodAcesso { get; set; }

    [SxProperty(ColumnName = "DESCRICAO", Title = "Descrição", Description = "Descrição do acesso", Required = true,
        MaxLength = 40)]
