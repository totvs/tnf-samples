...
[SXConstraint(Name = "pk_gusrperfil", Type = "primarykey",
    Columns = new[] { "CODCOLIGADA", "CODUSUARIO", "CODSISTEMA", "CODPERFIL" })]
[SXConstraint(Name = "fk_gusrperfil_gacesso", Type = "foreignkey", Columns = new[] { "CODACESSO" },
    ParentObjectName = "GACESSO", ParentColumns = new[] { "CODACESSO" })]
[SxFinder(new[] { nameof(CodColigada), nameof(CodUsuario), nameof(CodSistema), nameof(CodPerfil) }, '|',
    "{0}|{1}|{2}|{3}")]
public class UsuarioPerfilObjectEntity : SXObject<UsuarioPerfilObjectEntity>
{
    ...
    [SxProperty(ColumnName = "CODUSUARIO", Title = "Código do usuario", Description = "Código do usuario",
        IsPrimaryKey = true, MaxLength = 20)]
    ...
    [SxProperty(ColumnName = "CODACESSO", Title = "Código do acesso", Description = "Código do acesso", Required = true,
