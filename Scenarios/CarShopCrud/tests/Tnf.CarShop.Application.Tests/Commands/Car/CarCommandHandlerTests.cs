...
public class CarCommandHandlerTests
{
    ...
    public CarCommandHandlerTests()
    {
        ...
        _createHandler = new CarCommandCreateHandler(_carRepoMock.Object, _loggerCreateMock.Object,
            _carEventPublisherMock.Object);

        _updateHandler = new CarCommandUpdateHandler(_carRepoMock.Object, _loggerUpdateMock.Object,
            _carEventPublisherMock.Object);
    }
    ...
    public async Task Should_Create_Car_Successfully()
    {
        ...
        _carRepoMock
            ...
            .ReturnsAsync(
                new Domain.Entities.Car(command.Brand, command.Model, command.Year, command.Price, command.StoreId)
                {
                    Id = Guid.NewGuid()
                });
        ...
        _carRepoMock.Verify(c => c.InsertAsync(It.IsAny<Domain.Entities.Car>(), It.IsAny<CancellationToken>()),
            Times.Once);
        _carEventPublisherMock.Verify(
            c => c.NotifyCreationAsync(It.IsAny<Domain.Entities.Car>(), It.IsAny<CancellationToken>()), Times.Once);
    }
    ...
    public async Task UpdateCarCommandHandler_Should_Update_Car()
    {
        ...
        var handler = new CarCommandUpdateHandler(_carRepoMock.Object, _loggerUpdateMock.Object,
            _carEventPublisherMock.Object);
        ...
        _carRepoMock.Verify(x => x.UpdateAsync(It.IsAny<Domain.Entities.Car>(), It.IsAny<CancellationToken>()),
            Times.Once);
    }
}
