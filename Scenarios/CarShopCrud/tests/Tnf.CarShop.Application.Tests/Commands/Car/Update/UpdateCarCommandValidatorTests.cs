...
public class UpdateCarCommandValidatorTests
{
    ...
    public void Should_Have_Error_When_Id_Is_Empty()
    {
        ...
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(command.Id) && e.ErrorMessage == "CarId is required.");
    }
    ...
    public void Should_Have_Error_When_Brand_Is_Empty()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(command.Brand) && e.ErrorMessage == "Brand is required.");
    }
    ...
    public void Should_Have_Error_When_Brand_Length_Is_Less_Than_2()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(command.Brand) && e.ErrorMessage == "Brand should be between 2 and 100 characters long.");
    }
    ...
    public void Should_Have_Error_When_Model_Is_Empty()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(command.Model) && e.ErrorMessage == "Model is required.");
    }
    ...
    public void Should_Have_Error_When_Model_Length_Is_Less_Than_2()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(command.Model) && e.ErrorMessage == "Model should be between 2 and 100 characters long.");
    }
    ...
    public void Should_Have_Error_When_Year_Is_Less_Than_1900()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(command.Year) && e.ErrorMessage == $"Year should be between 1900 and {DateTime.Now.Year}.");
    }
    ...
    public void Should_Have_Error_When_Price_Is_Less_Than_0()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(command.Price) && e.ErrorMessage == "Price should be positive.");
    }
}