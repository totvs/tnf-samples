...
public class UpdateStoreCommandValidatorTests
{
    ...
    public void Should_Have_Error_When_Name_Is_Null()
    {
        ...
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(command.Name) && e.ErrorMessage == "Dealer Name is required.");
    }
    ...
    public void Should_Have_Error_When_Name_Is_Less_Than_2_Characters()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(command.Name) && e.ErrorMessage == "Dealer Name should be between 2 and 150 characters long.");
    }
    ...
    public void Should_Have_Error_When_Location_Is_Null()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(command.Location) && e.ErrorMessage == "Location is required.");
    }
    ...
    public void Should_Have_Error_When_Location_Is_Less_Than_5_Characters()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(command.Location) && e.ErrorMessage == "Location should be between 5 and 250 characters long.");
    }
