...
public class CarCommandUpdateHandler : CommandHandler<CarCommandUpdate, CarResult>
{
    ...
    public CarCommandUpdateHandler(ICarRepository carRepository, ILogger<CarCommandUpdateHandler> logger,
    ...
    public override async Task<CarResult> ExecuteAsync(CarCommandUpdate command,
