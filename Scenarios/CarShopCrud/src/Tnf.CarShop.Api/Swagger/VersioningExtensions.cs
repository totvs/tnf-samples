...
internal static class VersioningExtensions
{
    public static IServiceCollection AddCarShopApiVersioning(this IServiceCollection services)
    {
        ...
        {
            //Use ApiBehavior está true para que somente os controller que utilizam o attributo ApiControllerAttribute
    ...
    {
        app.UseSwagger(options => { options.RouteTemplate = "carshop/swagger/{documentname}/swagger.json"; });
