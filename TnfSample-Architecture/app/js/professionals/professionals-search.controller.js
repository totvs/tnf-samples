...
/**
* @module professional
* @name ProfessionalSearchController
* @object controller
*
...
(function () {
    ...
    angular
        .module('professional')
        .controller('ProfessionalSearchController', ProfessionalSearchController);

    ProfessionalSearchController.$inject = ['$modalInstance', 'data'];

    function ProfessionalSearchController($modalInstance, data) {
